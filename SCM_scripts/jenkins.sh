...
if [ "$DEBUG_MOD" == "false" ]
then
    SIGN_ARRAY=(E260L_CMCC E260L_CTCC E260L_CTCERT E262L_WW E266L_CMCC ZB500TL_CMCC ZB500TL_CTCC D281L_US E286L_CMCC E281L_TW E286L_IN E286L_CTCC E286L_CTCCMP D281L_WW D281L_JP D281L_ID E281L_ID)
    for i in "${SIGN_ARRAY[@]}"
    do
